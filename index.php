    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <form class="form-inline my-2 my-lg-0">
            <a class="btn btn-outline-info mr-2 " href="./inicio.php?p=registrarse">
                Registrarse <i class="fa fa-user-plus "></i>
            </a>
            <a class="btn btn-outline-danger mr-2 " href="./inicio.php?p=iniciarSesion">
                Iniciar Sesion <i class="fa fa-lock "></i>
            </a>
        </form>
